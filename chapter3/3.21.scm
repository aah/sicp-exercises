...
;; Explain what Eva Lu is talking about.  In particular, show why Ben's
;; examples produce the printed results that they do. Define a procedure
;; print-queue that takes a queue as input and prints the sequence of items in
;; the queue.
